(function (window, document) {
      ...
      function ($scope, $attrs, $parse) {
        ...
        $scope.select = function (item) {
          ...
          if (angular.isUndefined(output)) {
            throw new Error('\'beforeSelectionChange\' returned undefined as value! Check the binding function and/or the returned value');
          }
          if (output) {
  ...
  angular.module('listGroup').run([
    ...
    function ($templateCache) {
      ...
      $templateCache.put('linked-list-group.tpl.html', '<div class="list-group"><a ng-href="" class="list-group-item" ng-repeat="item in items" ng-class="{active : (isSelected(item) != -1), disabled : isDisabled(item) }" ng-click="select(item)">{{resolveLabel(item)}}</a></div>');
      $templateCache.put('list-group.tpl.html', '<ul class="list-group"><li class="list-group-item" data-ng-repeat="item in items">{{resolveLabel(item)}}</li></ul>');
